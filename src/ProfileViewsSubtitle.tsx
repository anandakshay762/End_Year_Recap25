...
interface ProfileViewsSubtitleProps {
  text: string;
  style?: CSSProperties;
}

export const ProfileViewsSubtitle: React.FC<ProfileViewsSubtitleProps> = ({ text, style }) => {
  ...
  return (
    <>
      ...
      <div style={bannerStyle} data-node-id="164:498">
        <p style={textStyle} data-node-id="164:496">
          {text}
        </p>
      </div>
    </>
