...
interface BadgesSubtitleProps {
  text: string;
  style?: CSSProperties;
}

export const BadgesSubtitle: React.FC<BadgesSubtitleProps> = ({ text, style }) => {
  ...
  return (
    <>
      ...
      <div style={bannerStyle} data-node-id="176:545">
        <p style={textStyle} data-node-id="176:544">
          {text}
        </p>
      </div>
    </>
