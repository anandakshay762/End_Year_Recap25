...
interface TimeSpentSubtitleProps {
  text: string;
  style?: CSSProperties;
}

export const TimeSpentSubtitle: React.FC<TimeSpentSubtitleProps> = ({ text, style }) => {
  ...
  return (
    <>
      ...
      <div style={bannerStyle} data-node-id="167:515">
        <p style={textStyle} data-node-id="167:510">
          {text}
        </p>
      </div>
    </>
