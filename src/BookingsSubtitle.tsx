...
interface BookingsSubtitleProps {
  text: string;
  style?: CSSProperties;
}

export const BookingsSubtitle: React.FC<BookingsSubtitleProps> = ({ text, style }) => {
  ...
  return (
    <>
      ...
      <div style={bannerStyle} data-node-id="166:507">
        <p style={textStyle} data-node-id="166:506">
          {text}
        </p>
      </div>
    </>
