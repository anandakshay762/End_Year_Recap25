...
export const Scene6Summit: React.FC<Scene6SummitProps> = ({
  ...
  const numberOpacity = interpolate(localFrame, [10, 25], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });

  // Context
  const contextOpacity = interpolate(localFrame, [50, 70], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });

  const contextX = interpolate(localFrame, [50, 70], [-30, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
